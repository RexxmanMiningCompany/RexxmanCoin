...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("QUAR Core QUAR-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  QUAR-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded QUAR transaction") + "\n" +
              "  QUAR-tx [options] -create [commands]   " + _("Create hex-encoded QUAR transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded QUAR transaction
