/* src/config/QUAR-config.h.  Generated from QUAR-config.h.in by configure.  */
/* src/config/QUAR-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef QUAR_CONFIG_H

#define QUAR_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The QUAR Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "QUAR Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/QUAR/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QUAR Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QUAR Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "QUARcore"
