    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("QUAR Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About QUAR Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  QUAR-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the QUAR in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an QUARtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 QUAR, 0.1 QUAR, 1 QUAR and 10 QUAR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://QUARcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://QUARcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("QUAR Core is shutting down...") + "<br /><br />" +
