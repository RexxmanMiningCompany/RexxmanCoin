    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("QUAR Core");
    ...
    QString copyrightTextQUAR   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The QUAR Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextQUAR);
