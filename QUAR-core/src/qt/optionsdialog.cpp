    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QUAR-light"), QVariant("light"));
    ui->theme->addItem(QString("QUAR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QUAR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QUAR-traditional"), QVariant("trad"));
