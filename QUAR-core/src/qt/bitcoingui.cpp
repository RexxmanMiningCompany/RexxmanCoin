    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("QUAR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QUAR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and QUAR: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About QUAR Core"), this);
    aboutAction->setStatusTip(tr("Show information about QUAR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QUAR Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QUAR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QUAR addresses"));
    ...
    openAction->setStatusTip(tr("Open a QUAR: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QUAR Core help message to get a list with possible QUAR Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("QUAR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QUAR network", "", count));
}
...
{
    QString strTitle = tr("QUAR Core"); // default title
