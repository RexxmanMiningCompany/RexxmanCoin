 ...
 *
 *   // network
 *   CQUARNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.QUARcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQUARNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QUARNetwork
// //   -- signature requirements : Key1(User)
// class CQUARNetworkVariable : public CGovernanceObject
// {
// private:
