// Copyright (c) 010 Satoshi Nakamoto
...
{
    const char* pszTimestamp = "Right lets try this again";
    const CScript genesisOutputScript = CScript() << ParseHex("041dc1a4fd128c8da30a9ffec14582df8cf706f73fba2872e2b0a603c3554e4206a4c81065da230f506ba9d39566f82a1e64b867bb85028867e28c1c3df7e0265f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 3 * 60; // QUAR: every blocks
        consensus.nPowTargetSpacing = 3 * 60; // QUAR: 2 minutes
        ...
        genesis = CreateGenesisBlock(1533562895, 18655, 0x1e0ffff0, 1, 20 * COIN);
   ...
   /*
	 //////////////
        //////////////
                ...
                // Reset genesis
                consensus.hashGenesisBlock = uint256S("0x0000020245c557f424a098fd43349f9f56d076f060253d3578496041ab65426e");
        ...
        */
        assert(consensus.hashGenesisBlock == uint256S("0000020245c557f424a098fd43349f9f56d076f060253d3578496041ab65426e"));
        assert(genesis.hashMerkleRoot == uint256S("cf021b39e6a29497f5c32bc387c0b1d8faeb6d340820cd6bb6c04208eb1539e7"));
        vSeeds.push_back(CDNSSeedData("QUAR1.seed.coolbits.io", ""));
        vSeeds.push_back(CDNSSeedData("QUAR2.seed.coolbits.io", ""));
        ...
        strSporkPubKey = "0469fbfd762eff74062fea86a96192b7b7f10d4b2dc34ded7d351666c0da12c6aaa211717f67ddfea5da275fe5feb10f3eee9f86496283c541c4ba190da3fecbad";
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x0000020245c557f424a098fd43349f9f56d076f060253d3578496041ab65426e")),
            1533562895, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("041dc1a4fd128c8da30a9ffec14582df8cf706f73fba2872e2b0a603c3554e4206a4c81065da230f506ba9d39566f82a1e64b867bb85028867e28c1c3df7e0265f");
        nDefaultPort = 29393;
        ...
        // Testnet QUAR addresses start with 'q'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,120);
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1513814400, 18655, 0x207fffff, 1, 20 * COIN);
